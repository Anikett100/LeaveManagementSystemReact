...
//     axios.get(`http://127.0.0.1:8000/api/attendance?month=${month}`)
//       .then(response => {
...
//               <td className="py-4 px-6">{employeeData.employee_name}</td>
//               {Array.from({ length: daysInMonth }, (_, i) => {
//                 const day = i + 1;
...
//                         <Clock size={16} color="#17a2b8"/> // Blue clock for First Half
//                       ) : leaveDay.leavetype === 'Second Half' && leaveDay.status === 'Approved' ? (
//                         <Clock size={16} color="#17a2b8"/> // Blue clock for Second Half
//                       ) : leaveDay.leavetype === 'Short Leave' && leaveDay.status === 'Approved' ? (
//                         <Clock size={16} color="#ffc107"/> // Yellow clock for Short Leave
//                       ) : (
